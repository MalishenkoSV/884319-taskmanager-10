...
const createFilterTemplate = () => {
  return (
    `<section class="main__filter filter container">
         <input type="radio" id="filter__all"
            class="filter__input visually-hidden" name="filter" checked/>
         <label for="filter__all" class="filter__label">All
             <span class="filter__all-count">1</span>
         </label>
         <input type="radio" id="filter__overdue" class="filter__input visually-hidden" name="filter" disabled/>
         <label for="filter__overdue" class="filter__label">Overdue
         ...
         <input type="radio"
                ...
                name="filter"
                disabled/>
         <label for="filter__today" class="filter__label">Today
         ...
         <input type="radio"
              ...
              name="filter"
              disabled/>
         <label for="filter__favorites" class="filter__label">Favorites
             <span class="filter__favorites-count">0</span>
         </label>
         <input type="radio"
            ...
            name="filter"
            disabled/>
         <label for="filter__repeating" class="filter__label">Repeating
              <span class="filter__repeating-count">0</span>
        </label>
         <input type="radio"
            id="filter__tags"
            class="filter__input visually-hidden"
            name="filter"
            disabled/>
         <label for="filter__tags" class="filter__label">Tags
             <span class="filter__tags-count">0</span>
         </label>
         <input type="radio"
            id="filter__archive"
            class="filter__input visually-hidden"
            name="filter"/>
         <label for="filter__archive" class="filter__label">Archive
              <span class="filter__archive-count">115</span></label>
    </section>`);
};
                        ...
                        <fieldset class="card__repeat-days">
                            <div class="card__repeat-days-inner">
                                <input class="visually-hidden card__repeat-day-input"
                                    ...
                                    name="repeat"
                                    value="mo"/>
                                <label class="card__repeat-day" for="repeat-mo-4">mo
                                </label>
                                <input class="visually-hidden card__repeat-day-input"
                                    type="checkbox"
                                    id="repeat-tu-4"
                                    ...
                                    value="tu"
                                    checked/>
                                <label class="card__repeat-day" for="repeat-tu-4">tu
                                </label>
                                <input class="visually-hidden card__repeat-day-input"
                                    type="checkbox"
                                    id="repeat-we-4"
                                    name="repeat"
                                    value="we"/>
                                <label class="card__repeat-day" for="repeat-we-4">we
                                </label>
                                <input
                                    ...
                                    name="repeat"
                                    value="th"/>
                                <label class="card__repeat-day" for="repeat-th-4">th
                                </label>
                                <input class="visually-hidden card__repeat-day-input"
                                    type="checkbox"
                                    id="repeat-fr-4"
                                    ...
                                    value="fr"
                                    checked/>
                                <label class="card__repeat-day" for="repeat-fr-4">fr
                                </label>
                                <input class="visually-hidden card__repeat-day-input"
                                    type="checkbox"
                                    name="repeat"
                                    value="sa"
                                    id="repeat-sa-4"/>
                                <label class="card__repeat-day" for="repeat-sa-4">sa
                                </label>
                                <input class="visually-hidden card__repeat-day-input"
                                    type="checkbox"
                                    id="repeat-su-4"
                                    ...
                                    value="su"
                                    checked/>
                                <label class="card__repeat-day" for="repeat-su-4">su
                                </label>
                            </div>
                        </fieldset>
                        </div>
                        ...
                        <div class="card__hashtag">
                            <div class="card__hashtag-list">
                                  <span class="card__hashtag-inner">
                                      ...
                                      <p class="card__hashtag-name">#repeat
                                      </p>
                                  ...
                                  <span class="card__hashtag-inner">
                                      <input  type="hidden"
                                        ...
                                        value="repeat"
                                        class="card__hashtag-hidden-input"/>
                                      <p class="card__hashtag-name">#cinema
                                      </p>
                                      <button type="button" class="card__hashtag-delete">delete
                                      </button>
                                  </span>
                    ...
                    <div class="card__colors-inner">
                        ...
                        <div class="card__colors-wrap">
                          ...
                          id="color-green-4"
                              ...
                              name="color"
                              value="green"/>
                            <label for="color-green-4" class="card__color card__color--green">green
                            </label>
                            <input type="radio"
                              id="color-pink-4"
...
render(placeMainElement, Object(_components_filter_js__WEBPACK_IMPORTED_MODULE_1__["createFilterTemplate"])());
render(placeMainElement, Object(_components_board_js__WEBPACK_IMPORTED_MODULE_5__["createBordTemplate"])());

const placeTaskListElement = placeMainElement.querySelector(`.board__tasks`);
render(placeTaskListElement, Object(_components_form_edit_js__WEBPACK_IMPORTED_MODULE_3__["createFormEditTaskTemplate"])());

const getMarkup = () => new Array(TASK_NUMBER).fill(Object(_components_task_js__WEBPACK_IMPORTED_MODULE_2__["createCardTaskTemplate"])()).join(``);
render(placeTaskListElement, getMarkup());
const bordElement = placeMainElement.querySelector(`.board`);
render(bordElement, Object(_components_load_more_button_js__WEBPACK_IMPORTED_MODULE_4__["createButtonLoadMoreTemplate"])());
